...
@section('after_styles')
  <!-- DATA TABLES -->
  <link rel="stylesheet" type="text/css" href="{{ external_asset('packages/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ external_asset('packages/datatables.net-fixedheader-bs4/css/fixedHeader.bootstrap4.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ external_asset('packages/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css') }}">
  ...
  <link rel="stylesheet" href="{{ external_asset('packages/backpack/crud/css/list.css') }}">
...
@section('after_scripts')
  ...
  <script src="{{ external_asset('packages/backpack/crud/js/list.js') }}"></script>
