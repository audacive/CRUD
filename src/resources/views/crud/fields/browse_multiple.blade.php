...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_styles')
        <link href="{{ external_asset('packages/jquery-colorbox/example2/colorbox.css') }}" rel="stylesheet" type="text/css" />
        <style>
    ...
    @push('crud_fields_scripts')
        ...
        <script src="{{ external_asset('packages/jquery-ui-dist/jquery-ui.min.js') }}"></script>
        <script src="{{ external_asset('packages/jquery-colorbox/jquery.colorbox-min.js') }}"></script>
        <script>
