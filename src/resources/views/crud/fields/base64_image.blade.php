...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_styles')
        <link href="{{ external_asset('packages/cropperjs/dist/cropper.min.css') }}" rel="stylesheet" type="text/css" />
        <style>
            .hide {
                display: none;
            }
    ...
    @push('crud_fields_scripts')
        <script src="{{ external_asset('packages/cropperjs/dist/cropper.min.js') }}"></script>
        <script src="{{ external_asset('packages/jquery-cropper/dist/jquery-cropper.min.js') }}"></script>
        <script>
