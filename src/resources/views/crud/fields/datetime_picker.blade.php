...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    <link rel="stylesheet" href="{{ external_asset('packages/bootstrap-datepicker/dist/css/bootstrap-datepicker3.css') }}">
    <link rel="stylesheet" href="{{ external_asset('packages/pc-bootstrap4-datetimepicker/build/css/bootstrap-datetimepicker.min.css') }}">
    @endpush

    {{-- FIELD JS - will be loaded in the after_scripts section --}}
    @push('crud_fields_scripts')
    <script type="text/javascript" src="{{ external_asset('packages/moment/min/moment.min.js') }}"></script>
    <script src="{{ external_asset('packages/pc-bootstrap4-datetimepicker/build/js/bootstrap-datetimepicker.min.js') }}"></script>
    @if ($field_language !== 'en')
        <script charset="UTF-8" src="{{ external_asset('packages/moment/min/locales.min.js') }}"></script>
    @endif
    <script>
