...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_styles')
        <link rel="stylesheet" href="{{ external_asset('packages/simplemde/dist/simplemde.min.css') }}">
        <style type="text/css">
    ...
    @push('crud_fields_scripts')
        <script src="{{ external_asset('packages/simplemde/dist/simplemde.min.js') }}"></script>
        <script>
