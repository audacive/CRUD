...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_styles')
        ...
        <link href="{{ external_asset('packages/summernote/dist/summernote-bs4.css') }}" rel="stylesheet" type="text/css" />
        <style type="text/css">
    ...
    @push('crud_fields_scripts')
        ...
        {{-- <script src="{{ external_asset('packages/summernote/dist/summernote.min.js') }}"></script> --}}
        <script src="{{ external_asset('packages/summernote/dist/summernote-bs4.min.js') }}"></script>
        <script>
