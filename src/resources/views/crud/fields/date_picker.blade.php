...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    <script src="{{ external_asset('packages/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
    @if ($field_language !== 'en')
        <script charset="UTF-8" src="{{ external_asset('packages/bootstrap-datepicker/dist/locales/bootstrap-datepicker.'.$field_language.'.min.js') }}"></script>
    @endif
    <script>
        if (jQuery.ui) {
